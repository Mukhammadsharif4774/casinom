...
import {casinomAllProducts} from '../helpers/casinomProducts';
import TrashIcon from '../assets/delete_icon.png';

const CasinomCartItemComponent = ({item}) => {
  ...
  const productImage = casinomAllProducts.find(
    p => p.name === item.name,
  )?.image;
...
export default CasinomCartItemComponent;
